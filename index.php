...
<body>
    ...
    <header class="header">
        ...
        <a href="#" class="logo">CS Cafeteria<i class="fas fa-mug-hot"></i></a>
        ...
        <!-- <a href="book" class="btn">book a table</a> -->
        <a href="register.php" onclick="click()" class="btn">Login</a>
        <a href="adminlogin.php" onclick="reserve()" class="btn">Admin</a>
        ...
        <div class="container">
          ...
          <div class="about-content">
            ...
            <p class="section-text">
              This Cafe Is rundown By many generation and its has many branches in this Town.
            </p>
...
<br>
            <h1>For More Food Items Please <a href="register.php" style="color: red;">Login</a></h1>
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <p>We Make Our Cafe Environment Friendly .<br>
                  We Also Provide Resrvation but to do it you should login First.
                </p>
        ...
        <div class="swiper review-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide box">
                    ...
                    <p>I recently had the pleasure of experiencing [product/service] and I must say, it exceeded all my expectations! From the moment I engaged with it, I was impressed by its [quality/ease of use/efficiency]. The attention to detail was evident in every aspect, from its sleek design to its intuitive interface..</p>
                    <h3>ritesh agarwal</h3>
                ...
                <div class="swiper-slide box">
                    ...
                    <p>I wholeheartedly recommend [product/service] to anyone looking for [specific benefit or solution]. Trust me, you won't be disappointed!</p>
                    <h3>kashish shetty</h3>
                    <span>satisfied client</span>
                </div>
                ...
                <div class="swiper-slide box">
                    ...
                    <p>I stumbled upon this charming café tucked away in the heart of the city, and I'm thrilled to say it's become my new favorite spot. From the moment I stepped inside, I was enveloped in a warm and inviting atmosphere that immediately put me at ease.</p>
                    <h3>rajpal yadav</h3>
                    <span>satisfied client</span>
                </div>
                ...
                <div class="swiper-slide box">
                    ...
                    <p>Not only does [product/service] deliver on its promises, but it also adds significant value to my life. Whether it's streamlining my daily tasks or enhancing my overall well-being, I can confidently say that [product/service] has become an indispensable part of my routine..</p>
    ...
    <section class="footer">
        <div class="box-container">
            ...
            <div class="box">
                <h3>contact info</h3>
                <a href="#"><i class="fas fa-phone"></i>+91 985745474</a>
                <a href="#"><i class="fas fa-phone"></i> +91 775745474</a>
